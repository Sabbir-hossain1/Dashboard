(function(global, factory) {
    ...
    const appCalendarInit = ()=>{
        const e = "#addEventForm"
          ...
          , p = "event"
          , g = "fc-view"
          , D = events.reduce(((e,t)=>t.schedules ? e.concat(t.schedules.concat(t)) : e.concat(t)), []);
        (()=>{
            const e = new Date
              ...
              , n = e.getDay()
              , l = `${a}  ${t},  ${e.getFullYear()}`;
            document.querySelector(r) && (document.querySelector(r).textContent = (e=>["Sunday", "Monday", "Tuesday", "Wednesday", "Thursday", "Friday", "Saturday"][e])(n)),
            document.querySelector(o) && (document.querySelector(o).textContent = l);
        }
        )();
        const S = e=>{
            ...
            if ("timeGridWeek" === t) {
                ...
                document.querySelector(n).textContent = e.viewTitle;
        }
        ...
        if (f) {
            const e = fullCalendar.renderCalendar(f, {
                ...
                dateClick(e) {
                    ...
                    document.querySelector(i)._flatpickr.setDate([e.dateStr]);
                }
            });
            S(e.currentData),
            ...
            document.querySelectorAll(l).forEach((t=>{
                t.addEventListener(m, (t=>{
                    t.preventDefault();
                    const a = t.currentTarget;
                    e.changeView(getData(a, g)),
                    S(e.currentData);
                }
                ));
            }
            )),
            h && h.addEventListener(y, (t=>{
                t.preventDefault();
                const {title: a, startDate: n, endDate: r, label: o, description: l, allDay: c} = t.target;
                e.addEvent({
                    title: a.value,
                    start: n.value,
            ...
            w && w.addEventListener(v, (({currentTarget: e})=>{
    ...
    const chatInit = ()=>{
        ...
        if (u) {
            ...
            t.forEach((t=>t.addEventListener("shown.bs.tab", (()=>{
                ...
                a.filter((e=>"all" === o || e.elm.classList.contains(o)));
            }
            ))));
        }
        if (l.forEach((e=>{
        ...
        if (l.length && window.google) {
            ...
            l.forEach((l=>{
                ...
                const p = {
                    ...
                    styles: "dark" === localStorage.getItem("phoenixTheme") ? s.SnazzyCustomDark : s[n || "SnazzyCustomLight"]
                }
      ...
      , listInit = ()=>{
        ...
        if (window.List) {
            ...
            t.length && t.forEach((t=>{
                ...
                const a = t.querySelector('[data-list-pagination="next"]')
                  ...
                  , d = new List(t,n);
                d.on("updated", (e=>{
                    const i = t.querySelector(".fallback") || document.getElementById(n.fallback);
                    i && (0 === e.matchingItems.length ? i.classList.remove("d-none") : i.classList.add("d-none"));
                }
                ));
                ...
                const p = ()=>{
                    c && (c.innerHTML = `${d.i} to ${m} <span class='text-600'> Items of </span>${g}`),
                    l && togglePaginationButtonDisable(l, 1 === v),
                    a && togglePaginationButtonDisable(a, v === b),
                    v > 1 && v < b && (togglePaginationButtonDisable(a, !1),
                ...
                n.pagination && t.querySelector(".pagination").addEventListener("click", (e=>{
                    "page" === e.target.classList[0] && (v = Number(e.target.innerText),
                    p());
                }
                )),
                n.filter) {
                    ...
                    r.addEventListener("change", (t=>{
                        d.filter((i=>"" === t.target.value || i.values()[e].toLowerCase().includes(t.target.value.toLowerCase())));
                    }
                    ));
                }
                i && i.addEventListener("change", (()=>{
                    console.log({
                        bulkSelect: i.checked
                    }),
                    d && (i.checked ? d.items.forEach((e=>{
    ...
    const navbarComboInit = ()=>{
        const {getBreakpoint: e, getData: n, addClass: r, hasClass: o, resize: t} = window.phoenix.utils
          , a = ".navbar-vertical"
    ...
    const handleNavbarVerticalCollapsed = ()=>{
        const {getItemFromStore: e, hasClass: a, setItemToStore: t} = window.phoenix.utils
          , l = "html"
        ...
        u && u.addEventListener(s, (a=>{
            u.blur(),
            p?.classList.toggle(d);
    ...
    const {config: config} = window.config
      , initialDomSetup = e=>{
        const {getData: t, getItemFromStore: o, setItemToStore: a} = window.phoenix.utils;
      ...
      , themeControl = ()=>{
        ...
        o.on("click", (c=>{
            ...
            if (n.data("theme-control")) {
                ...
                let i = c.target["radio" === c.target.type ? "value" : "checked"];
                switch ("phoenixTheme" === l && "boolean" == typeof i && (i = i ? "dark" : "light"),
                config.hasOwnProperty(l) && e(l, i),
                window.history.replaceState(null, null, window.location.pathname),
                l) {
                case "phoenixTheme":
                    {
                        document.documentElement.classList["dark" === i ? "add" : "remove"]("dark");
                ...
                case "phoenixNavbarVerticalStyle":
                    ...
                    "default" !== i && a.classList.add(`navbar-${i}`);
                    break;
                case "phoenixNavbarTopStyle":
                    r.classList.remove("navbar-darker"),
                    "transparent" !== i && r.classList.add(`navbar-${i}`);
                    break;
                case "phoenixNavbarTopShape":
                    {
                        const e = t(n.node, "page-url");
                        e ? window.location.replace(e) : window.location.reload();
                    }
                    break;
                case "phoenixNavbarPosition":
                    ...
                    break;
                case "phoenixIsRTL":
                    localStorage.setItem("phoenixIsRTL", n.node.checked),
    ...
    const {merge: merge} = window._
      , tinymceInit = ()=>{
        ...
        if (window.tinymce) {
            ...
            o && o.addEventListener("clickControl", (({detail: {control: t}})=>{
    ...
    const wizardInit = ()=>{
        ...
        document.querySelectorAll(t.WIZARDS).forEach((o=>{
            ...
            let S = 0
              , T = null;
            n.forEach((e=>{
                e.addEventListener(a, (t=>(t.preventDefault(),
                e.classList.contains("needs-validation") && (i && c && (i.value !== c.value ? c.setCustomValidity("Invalid field.") : c.setCustomValidity("")),
            ...
            l.length && l.forEach(((t,a)=>{
                t.addEventListener(s, (a=>{
                    ...
                    T = a,
                    s > S && n[S].dispatchEvent(v);
                }
                )),
                t.addEventListener(r, (()=>{
                    S = a,
                    S === l.length - 1 && l.forEach((e=>{
                    ...
                    for (let e = 0; e < S; e += 1)
                        ...
                        e > 0 && l[e - 1].classList.add("complete");
                    for (let e = S; e < l.length; e += 1)
                        l[e].classList.remove("done"),
                        e > 0 && l[e - 1].classList.remove("complete");
                    S > l.length - 2 ? E.classList.add("d-none") : E.classList.remove("d-none"),
                    S > 0 ? w.classList.remove("d-none") : w.classList.add("d-none");
                }
                ));
            }
            ));
